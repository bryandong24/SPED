<!-- FORK NOTE: this is `spedcopycausalforcing`, a self-contained fork of
gino/causal-forcing-fw2step with SPEED (training-free progressive-resolution
inference) wired in. See README_SPEED.md for the fork's usage and benchmarks.
The text below is the upstream Causal-Forcing README, kept for reference. -->
