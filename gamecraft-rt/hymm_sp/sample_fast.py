...
def main():
    ...
    # FAST: tie the input-image crop size to the requested --video-size so low-res runs match.
    closest_size = (int(args.video_size[0]), int(args.video_size[1]))
    ...
    for idx, action_id in enumerate(action_list):
        ...
        outputs = hunyuan_video_sampler.predict(
            ...
            is_image=is_image,
            size=(int(args.video_size[0]), int(args.video_size[1])),
            seed=seed,
